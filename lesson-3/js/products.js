...
let totalData = document.querySelector('tfot td:first-of-type');
...
for(let i=0;i<products.length;i++){
	...
	console.log('this is the inner HTML' + itemRow.innerHTML);
	console.log('this is the inner text' + itemRow.innerText);
